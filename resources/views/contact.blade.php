          ...
          <div class="row align-items-end ">
            <div class="col-lg-5">
              ...
              <div class="intro">
                ...
                <div class="custom-breadcrumbs"><a href="{{route('frontend.home')}}">Home</a> <span class="mx-2">/</span> <strong>Contact</strong></div>
              </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mb-5" >
            <form  action="{{route('admin.newmessage')}}" method="Post" enctype="multipart/form-data">
              @csrf
