                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"action="{{route('admin.updatecar',[$car->id])}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" id="title" required="required" class="form-control" value=
                                        "{{$car->title}}">
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input id="luggage" class="form-control" type="number" name="luggage" required="required" value=
                                        "{{$car->luggage}}">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input id="doors" class="form-control" type="number" name="doors" required="required" value=
                                        "{{$car->doors}}">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input id="passengers" class="form-control" type="number" name="passengers" value=
                                        "{{$car->passengers}}" required="required">
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" class="flat" @checked($car->active)>
                                        </label>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <img src="{{asset('assets/images/' . $car->image) }}" style="width: 300px;">
                                    </div>
                                </div>
