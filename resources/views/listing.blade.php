          ...
          <div class="row align-items-end ">
            <div class="col-lg-5">
              ...
              <div class="intro">
                ...
                <div class="custom-breadcrumbs"><a href="{{route('frontend.home')}}">Home</a> <span class="mx-2">/</span> <strong>Listings</strong></div>
              </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              ...
              <div class="listing-contents h-100">
                ...
                <div>
                  <p>{{ Illuminate\Support\Str::limit($car['content'], $limit = 20, $end = '...') }}</p>


                  <p><a href="singlepage/{{ $car['id'] }}" class="btn btn-primary btn-sm">Rent Now</a></p>
        ...
        <div class="row">
          <div class="col-5">
              <div class="custom-pagination">
                  ...
                  @else
                      <a href="{{ $cars->previousPageUrl() }}">1</a>
                  @endif
                  ...
                  @for ($i = max(2, $cars->currentPage() - 1); $i <= min($cars->lastPage(), $cars->currentPage() + 1); $i++)
                  ...
                  @if ($cars->hasMorePages())
                      <a href="{{ $cars->nextPageUrl() }}">{{ $cars->lastPage() }}</a>
                  @endif
              </div>
          </div>
      </div>
